...
تم تطوير منصة سياحية متكاملة ومتطورة باستخدام Laravel 12 و PHP 8.2 لتقديم تجربة سياحية شاملة لاستكشاف جمال سوريا. المنصة تتيح للمستخدمين تصفح الرحلات السياحية، حجز الرحلات، استكشاف المحافظات والأماكن السياحية، وقراءة المقالات والمراجعات.
...
✅ **نظام المصادقة والأمان**: تسجيل دخول متقدم، المصادقة الثنائية (2FA)، تسجيل الدخول عبر وسائل التواصل الاجتماعي
...
**ملاحظة**: المشروع كامل وجاهز للاستخدام، مع توثيق شامل واختبارات متكاملة.
